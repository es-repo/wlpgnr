...
namespace WallpaperGenerator.Utilities.Testing.DataStructures.Trees.TreeGenerating
{
    ...
    {
        [Test]
        [TestCase(1, null, new[] { "Node0" })]
        [TestCase(2, null, new[] { "Node1", "Node0" })]
        [TestCase(3, null, new[] { "Node1", "Node2", "Node0", "Node0" })]
        [TestCase(4, null, new[] { "Node1", "Node2", "Node1", "Node0", "Node2", "Node0", "Node0" })]
        [TestCase(5, null, new[] { "Node1", "Node2", "Node1", "Node2", "Node0", "Node0", "Node1", "Node2", "Node0", "Node0" })]
        [TestCase(3, new[] { "Node0" }, new[] { "Node0" })]
